...
export class CardService {
  ...
  cards = [
    ...
    { title: 'Постоянная коммуникация', description: 'Регулярно информируем клиентов о ходе проекта и обеспечиваем открытое взаимодействие на всех этапах разработки.', imageUrl: 'assets/imagies/card3.png' },
    {
      ...
      description: 'Наши решения легко адаптируются в соответствии с ростом вашего бизнеса и меняющимися требованиями рынка.',
      imageUrl: 'assets/imagies/card4.png'
    },
    {
      title: 'Краткие сроки выполнения',
      description: 'Оптимизированные процессы разработки позволяют нам эффективно управлять временем и сдавать проекты точно в срок.',
      imageUrl: 'assets/imagies/card5.png'
    },
  ];
